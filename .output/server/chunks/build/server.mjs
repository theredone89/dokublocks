...
import { p as parseURL, m as encodePath, n as decodePath, o as hasProtocol, q as isScriptProtocol, k as joinURL, w as withQuery, t as sanitizeStatusCode, v as getContext, $ as $fetch, x as createHooks, f as createError$1, y as executeAsync, z as defu } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-DtbgvEkW.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BGv0HiGq.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-wakc7_DU.mjs'));
