...
import { j as joinRelativeURL, u as useRuntimeConfig, g as getResponseStatusText, b as getResponseStatus, c as defineRenderHandler, e as getQuery, f as createError, h as destr, i as getRouteRules, k as joinURL, l as useNitroApp } from '../nitro/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1, viewport-fit=cover"},{"name":"theme-color","content":"#1a1a2e","id":"theme-color-meta"},{"name":"apple-mobile-web-app-capable","content":"yes"},{"name":"apple-mobile-web-app-status-bar-style","content":"black-translucent","id":"apple-status-bar"},{"name":"apple-mobile-web-app-title","content":"BlockLogic"},{"name":"description","content":"A captivating puzzle game combining Sudoku grids with Tetris-style block placement mechanics"}],"link":[{"rel":"stylesheet","href":"/css/styles.css"},{"rel":"icon","type":"image/png","href":"/img/icon-192.png"},{"rel":"apple-touch-icon","href":"/img/icon-192.png"}],"style":[],"script":[{"src":"/js/Grid.js"},{"src":"/js/Pieces.js"},{"src":"/js/ScoreManager.js"},{"src":"/js/ScoreBackupManager.js"},{"src":"/js/Renderer.js"},{"src":"/js/InputHandler.js"},{"src":"/js/Game.js"},{"src":"/js/main.js"}],"noscript":[],"title":"BlockLogic - Blockudoku Game"};
